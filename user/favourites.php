...
$favs = $conn->query(
   ...
   props.price AS price, props.beds AS beds, props.bath AS bath, props.sq_ft AS sq_ft,
   props.image AS image, props.location AS location, props.type AS type 
   FROM props INNER JOIN favs ON props.id = favs.prop_id WHERE favs.user_id = '$_SESSION[user_id]'"
);
...
<div class="site-wrap">
    ...
    <div class="site-blocks-cover inner-page-cover overlay" style="background-image: url(<?php echo APPURL; ?>/images/fav.jpg);" data-aos="fade" data-stellar-background-ratio="0.5">
        <div class="container">
    ...
    <div class="container">
        <div class="row mb-5">
            ...
            <?php else : ?>
                <div class="col-md-12">
                    <h2 class="bg-info text-center mt-5">You have no favourites yet</h2>
                </div>
            <?php endif; ?>
        </div>
    </div>
