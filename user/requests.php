...
$requests = $conn->query(
   ...
   FROM props INNER JOIN requests ON props.id = requests.prop_id WHERE requests.user_id = '$_SESSION[user_id]'"
);
...
<div class="site-wrap">
    ...
    <div class="container">
        <div class="row mb-5">
            ...
            <?php else : ?>
                <div class="col-md-12">
                    <h2 class="bg-info text-center mt-5">You have no requests yet</h2>
                </div>
            <?php endif; ?>
        </div>
    </div>
