...
if (isset($_POST['submit'])) {
    ...
    $search = $conn->query("SELECT * FROM props WHERE home_type LIKE '%$types%' 
    AND type LIKE '%$offers%' AND location LIKE '%$cities%' ");
    $search->execute();
    ...
    <div class="container">
        ...
        <div class="row mb-5">
            ...
            <?php if (count($listings) > 0) : ?>
                    ...
                    <div class="col-md-6 col-lg-4 mb-4">
                        <div class="property-entry h-100">
                            ...
                            <div class="p-4 property-body">
                                ...
                                <ul class="property-specs-wrap mb-3 mb-lg-1">
                                    <li>
                                        <span class="property-specs">Beds</span>
                                        <span class="property-specs-number"><?php echo $listing->beds; ?></span>
                                    </li>
                                    <li>
                                        <span class="property-specs">Bath</span>
                                        <span class="property-specs"><?php echo $listing->bath; ?></span>
                                    </li>
                                    <li>
                ...
                <?php endforeach ?>
            <?php else : ?>
                <div class="bg-succes text-white">We don't have any listing with this query for now</div>
            <?php endif ?>
        </div>
    </div>
</div>
