...
if (isset($_GET['type'])) {
  $type = $_GET['type'];
  $sale = $conn->query("SELECT * FROM props WHERE type='$type'");
  $sale->execute();
  $alllistings = $sale->fetchAll(PDO::FETCH_OBJ);
// } else {
        ...
        <div class="col-md-6 col-lg-4 mb-4">
          <div class="property-entry h-100">
            <a href="property-details.php?id=<?php echo $alllisting->id; ?>" class="property-thumbnail">
              ...
              <img src="<?php echo THUMBNAILSURL; ?>/<?php echo $alllisting->image; ?>" alt="Image" class="img-fluid">
            </a>
    ...
    <div class="row">
      <div class="col-md-6 col-lg-4">
        <a href="#" class="service text-center">
          ...
          <p>Get detailed insights into various neighborhoods to make informed decisions.</p>
      ...
      <div class="col-md-6 col-lg-4">
        <a href="#" class="service text-center">
          ...
          <p>Access our extensive database of properties that have found their perfect owners.</p>
          <p><span class="read-more">Read More</span></p>
        </a>
      </div>
      <div class="col-md-6 col-lg-4">
        <a href="#" class="service text-center">
          ...
          <p>Experience peace of mind with our top-notch security measures and data protection.</p>
          <p><span class="read-more">Read More</span></p>
        </a>
      </div>
    </div>
