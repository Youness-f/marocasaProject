...
define("THUMBNAILSURL", "http://localhost/homeland/admin-panel/properties-admins/thumbnails");
...
<head>
  <title>Moroccan Dream Homes &mdash;</title>
  <meta charset="utf-8">
      ...
      <div class="container py-1">
        <div class="row align-items-center">
          <div class="col-8 col-md-8 col-lg-4">
            <h1 class="mb-0"><a href="<?php echo APPURL; ?>" class="text-white h2 mb-0"><strong style="color: white;">Maro<span class="text-danger"></span></strong><strong style="color: red;">Casa<span class="text-danger"></span></strong></a></h1>
          </div>
