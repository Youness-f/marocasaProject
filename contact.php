...
<div class="site-blocks-cover inner-page-cover overlay" style="background-image: url(images/contact.jpeg);" data-aos="fade" data-stellar-background-ratio="0.5">
  <div class="container">
    ...
    <div class="row">
      ...
      <div class="col-lg-4">
        <div class="p-4 mb-3 bg-white">
          ...
          <p class="mb-4">203 Bd Allal Lfassi. Nahda, Khouribga, Maroc</p>

          <p class="mb-0 font-weight-bold">Phone</p>
          <p class="mb-4"><a href="#">+212 654197613</a></p>

          <p class="mb-0 font-weight-bold">Email Address</p>
          <p class="mb-0"><a href="#">MaroCasa@marocasa.com</a></p>
        </div>
      </div>
    </div>
  </div>
